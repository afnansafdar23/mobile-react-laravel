                        ...
                        <div data-kt-search-element="content"
                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <form data-kt-search-element="form" class="w-100 position-relative mb-3"
                                    ...
                                    <!--end::Input-->
                                    <!--begin::Spinner-->
                                    <span class="position-absolute top-50 translate-middle-y lh-0 d-none end-0 me-1"
                                    ...
                                    <!--begin::Reset-->
                                    <span
                                        class="btn btn-flush btn-active-color-primary position-absolute top-50 translate-middle-y lh-0 d-none end-0"
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link flex-stack px-3">Create Payment
                                                <i class="fas fa-exclamation-circle fs-7 ms-2"
