        ...
        <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                ...
                <div class="card mb-xl-8 mb-5" style="user-select: auto;">
                    ...
                    <div class="card-header border-0 pt-5" style="user-select: auto;">
                        <h3 class="card-title align-items-start flex-column" style="user-select: auto;">
                            <span class="card-label fw-bold fs-3 mb-1" style="user-select: auto;">All Parent
                                Categories</span>
                        </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td data-filter="image">
                                                <img src="{{asset($parentCategory->getFirstMediaUrl('parentCategory.image')) }}"
                                                    class="w-55px me-3" alt="">
                                            </td>
                                            <!--end::Image-->
                                            <!--begin::Name=-->
                                            <td>
                                                <span class="text-gray-800 mb-1">{{$parentCategory['name']}}</span>
                                            </td>
                                            <!--end::Name=-->
                                            <!--begin::desc=-->
                                            <td><span
                                                    class="text-gray-800 mb-1">{{$parentCategory['description']}}</span>
                                            </td>
                                            <!--end::desc=-->
                                            <!--begin::Action=-->
                                            <td class="text-end">
                                                <a type="button" class="btn btn-sm btn-light btn-active-light-primary"
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a type="button" data-bs-toggle="modal"
                                                            data-bs-target="#edit_category{{$parentCategory['id']}}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a type="button" class="menu-link px-3" data-bs-toggle="modal"
                                                            data-bs-target="#destroy_category{{$parentCategory['id']}}">Delete</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->
                                        ...
                                        <div class="modal fade" id="edit_category{{$parentCategory['id']}}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    <!--begin::Form-->
                                                    <form class="form"
                                                        action="{{route('parent.category.update',$parentCategory['id'])}}"
                                                            ...
                                                            <div class="scroll-y me-n7 pe-7" id="add_category_scroll"
                                                                ...
                                                                <div class="row">
                                                                    <div
                                                                        ...
                                                                        => $parentCategory,'collection_name' =>
                                                                        'parentCategory.image','dropzone_name'=>'edit_image'])
                                                                        <!--end::Input-->
                                                                        <div
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    ...
                                                                    <textarea type="text" row="3"
                                                                        class="form-control form-control-solid"
                                                                        placeholder=""
                                                                        name="description">{{$parentCategory['description']}}</textarea>
                                                                    <!--end::Textarea-->
                                                                </div>
                                                                <!--end::Input group-->
                                                            </div>
                                        ...
                                        <div class="modal fade" id="destroy_category{{$parentCategory['id']}}"
                                            tabindex="-1" aria-modal="true" role="dialog">
                                            <!--begin::Modal dialog-->
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                <!--begin::Modal content-->
                                                <div class="modal-content">
                                                    <!--begin::Form-->
                                                    <form class="form"
                                                        action="{{route('parent.category.destroy',$parentCategory['id'])}}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <!--begin::Modal header-->
                                                        <div class="modal-header" id="add_category_header">
            ...
            <div class="modal fade" id="add_category" tabindex="-1" aria-modal="true" role="dialog">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        <!--begin::Form-->
                        <form class="form" action="{{route('parent.category.store')}}" method="POST"
