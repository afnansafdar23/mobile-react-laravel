                ...
                <div class="card mb-5 mb-xl-8" style="user-select: auto;">
                    ...
                    <div class="card-header border-0 pt-5" style="user-select: auto;">
                        ...
                        <div class="d-flex gap-2 align-items-center py-1">
                            ...
                            <a href="{{ route('permission.synchronize') }}" class="btn btn-sm btn-primary">Synchronize
                                Permission</a>
                            @endcan
                            @can('permission.create')
                            <a href="{{ route('permission.create') }}" class="btn btn-sm btn-primary">Add New
                                Permission</a>
                            @endcan
                        </div>
                    </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr class="odd">
                                            ...
                                            <!--begin::Name=-->
                                            <td>
                                                <span class="text-gray-800 mb-1">{{$permission['name']}}</span>
                                            </td>
                                            <!--end::Name=-->
                                            <!--begin::desc=-->
                                            <td><span class="text-gray-800 mb-1">{{$permission['guard_name']}}</span>
                                            </td>
                                            <!--end::desc=-->
                                            <!--begin::Action=-->
                                            <td class="text-end">
