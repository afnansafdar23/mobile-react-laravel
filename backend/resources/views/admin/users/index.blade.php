                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px sorting" tabindex="0"
                                                ...
                                                style="width: 148.49px;">Email</th>
                                            <th class="min-w-125px sorting" tabindex="0"
                                                aria-controls="kt_categorys_table" rowspan="1" colspan="1"
                                                aria-label="Role: activate to sort column ascending"
                                                style="width: 148.49px;">Role</th>
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td data-filter="image">
                                                <img src="{{ asset($user->getFirstMediaUrl('product.image')) }}"
                                            ...
                                            <!--end::Name=-->
                                            <!--begin::desc=-->
                                            <td><span class="text-gray-800 mb-1">{{$user['email']}}</span>
                                            </td>
                                            <!--end::desc=-->
