        ...
        <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px sorting" tabindex="0"
                                                ...
                                                style="width: 148.49px;">Parent Category</th>
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td data-filter="image">
                                                <img src="{{ asset($childCategory->getFirstMediaUrl('childCategory.image')) }}"
                                                    class="w-35px me-3" alt="">
                                            </td>
                                            <!--end::Image-->
                                            <!--begin::Name=-->
                                            <td>
                                                <span class="text-gray-800 mb-1">{{$childCategory['name']}}</span>
                                            </td>
                                            <!--end::Name=-->
                                            <!--begin::desc=-->
                                            <td><span
                                                    class="text-gray-800 mb-1">{{$childCategory['description']}}</span>
                                            </td>
                                            <!--end::desc=-->
                                            <!--begin::parent category=-->
                                            <td><span
                                                    class="text-gray-800 mb-1">{{$childCategory->parentCategory->name}}</span>
                                            </td>
                                            <!--end::parent category=-->
                                            <!--begin::Action=-->
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a type="button" data-bs-toggle="modal"
                                                            data-bs-target="#edit_category{{$childCategory['id']}}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a type="button" class="menu-link px-3" data-bs-toggle="modal"
                                                            data-bs-target="#destroy_category{{$childCategory['id']}}">Delete</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->
                                        ...
                                        <div class="modal fade" id="edit_category{{$childCategory['id']}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    <!--begin::Form-->
                                                    <form class="form"
                                                        action="{{route('child.category.update',$childCategory['id'])}}"
                                                            ...
                                                            <div class="scroll-y me-n7 pe-7" id="add_category_scroll"
                                                                ...
                                                                <div class="row">
                                                                    <div
                                                                        ...
                                                                        => $childCategory,'collection_name' =>
                                                                        'childCategory.image','dropzone_name'=>'edit_image'])
                                                                        <!--end::Input-->
                                                                        <div
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    ...
                                                                    <textarea type="text" row="3"
                                                                        class="form-control form-control-solid"
                                                                        placeholder=""
                                                                        name="description">{{$childCategory['description']}}</textarea>
                                                                    <!--end::Textarea-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <!--begin::Input--><label
                                                                        class="fs-6 fw-bold mb-2">Parent
                                                                        Category</label>
                                                                    <select name="parent_category_id"
                                                                        ...
                                                                        @empty
                                                                        <span>please add parent category first</span>
                                                                        @endforelse
                                                                    </select>
                                                                    <!--end::Input-->
                                                                    <div
                                        ...
                                        <div class="modal fade" id="destroy_category{{$childCategory['id']}}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content">
                                                    <!--begin::Form-->
                                                    <form class="form"
                                                        action="{{route('child.category.destroy',$childCategory['id'])}}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <!--begin::Modal header-->
                                                        <div class="modal-header" id="add_category_header">
            ...
            <div class="modal fade" id="add_category" tabindex="-1" aria-modal="true" role="dialog">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        <!--begin::Form-->
                        <form class="form" action="{{route('child.category.store')}}" method="POST"
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="scroll-y me-n7 pe-7" id="add_category_scroll" data-kt-scroll="true"
                                    ...
                                    <!--end::Input group-->
                                    <div class="col-lg-12 fv-row">
                                        <!--begin::Input--><label class="fs-6 fw-bold mb-2">Parent Category</label>
                                        <select name="parent_category_id" aria-label="Select a Category"
                                            ...
                                            <option value="{{$parentCategory['id']}}"
                                                data-select-id="select2-data-131-4pfx">{{$parentCategory['name']}}
                                            </option>
                                            @empty
                                            <span>please add parent category first</span>
                                            @endforelse
