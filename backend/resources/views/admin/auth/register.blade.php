...
@section('content')
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid flex-lg-row-fluid w-100 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat"
            style="background-image: url({{ asset('assets/media/auth/bg9.jpg') }})">
            <!--begin::Logo-->
            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="d-flex flex-stack py-2">
                        ...
                        <!--begin::Sign Up link-->
                        <div class="m-0">
                            <span class="fw-bold fs-5 me-2 text-gray-400" data-kt-translate="sign-up-head-desc">Already a
                                member ?</span>
                    ...
                    <div class="py-20">
                        ...
                        <form class="form w-100" action="{{ route('auth.check.register') }}" method="POST">
                            ...
                            <div class="mb-10 text-start">
                                <!--begin::Title-->
                                <h1 class="fs-3x mb-3 text-white" data-kt-translate="sign-up-title">Create an Account</h1>
                                <!--end::Title-->
                                <!--begin::Text-->
                                <div class="fw-semibold fs-6 text-gray-400" data-kt-translate="general-desc">Get unlimited
                            ...
                            <div class="fv-row mb-10" data-kt-password-meter="true">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="position-relative mb-3">
                                        ...
                                        @enderror
                                        <span
                                            class="btn btn-sm btn-icon position-absolute translate-middle top-50 me-n2 end-0"
                                    ...
                                    <div class="d-flex align-items-center mb-3" data-kt-password-meter-control="highlight">
                                        <div class="flex-grow-1 bg-secondary bg-active-success h-5px me-2 rounded"></div>
                                        <div class="flex-grow-1 bg-secondary bg-active-success h-5px me-2 rounded"></div>
                                        <div class="flex-grow-1 bg-secondary bg-active-success h-5px me-2 rounded"></div>
                                        <div class="flex-grow-1 bg-secondary bg-active-success h-5px rounded"></div>
                                    </div>
                                    <!--end::Meter-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Hint-->
                                <div class="text-light" data-kt-translate="sign-up-hint">Use 8 or more characters with a mix
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="fw-semibold fs-6 me-6 text-gray-400">Or</div>
                                    <!--begin::Symbol-->
                    ...
                    <div class="m-0">
                        ...
                        <button class="btn btn-flex btn-link rotate" data-kt-menu-trigger="click"
                            ...
                            <span class="svg-icon svg-icon-3 svg-icon-muted m-0 rotate-180">
