    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid flex-lg-row-fluid w-100 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat"
            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="d-flex flex-stack py-2">
                        ...
                        <!--begin::Sign Up link-->
                        <div class="m-0">
                            <span class="fw-bold fs-5 me-2 text-gray-400" data-kt-translate="sign-in-head-desc">Not a
                                Member yet?</span>
                        ...
                        <form class="form w-100" action={{ route('auth.login.user') }} method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-10 text-start">
                                    <!--begin::Title-->
                                    <h1 class="fs-3x mb-3 text-white" data-kt-translate="sign-in-title">Sign In</h1>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="fw-semibold fs-6 text-gray-400" data-kt-translate="general-desc">Get
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="fw-semibold fs-6 me-md-6 me-3 text-gray-400"
            ...
            {{-- <div class="d-none d-lg-flex flex-lg-row-fluid w-100 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat"
                style="background-image: url({{ asset('assets/media/auth/bg10.jpeg') }})"></div> --}}
            <!--begin::Body-->
        </div>
