    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="container-one mt-3">
                <div class="container-fluid bg-light shadow p-3 rounded">
                    <h4><b>Filter</b></h4>
                    <hr class="bg-danger" style="height: 2px; width: 80%;">
                    <!-- form -->
                    <form action="#" method="post">
                        ...
                        <div>
                            ...
                            <select name="filter-category" id="f-category">
                                ...
                                <option value="PC">Protective Cases</option>
                                <option value="FC">Fashion Cases</option>
                                <option value="RC">Rugged Cases</option>
                                <option value="CC">Custom Cases</option>
                                <option value="WC">Wallet Cases</option>
                            </select>
                        </div>
                        <!-- Filter Manufactruer -->
                        <hr class="bg-danger" style="height: 2px; width: 80%;">
                        ...
                        <div class="product-card">
                            <div class="product-card-image">
                                <a href="{{route('product.details',$product['id'])}}">
                                    <img src="{{asset($product->getFirstMediaUrl('product.image'))}}" alt=""></a>
                            </div>
                            <div class="product-card-details">
                                <a
                                    href="{{route('product.details',$product['id'])}}"><small>{{$product['name']}}</small></a><br>
                                <p>£{{$product['discounted_price']}} <del>£{{$product['price']}}</del> | <span
