...
import banner from "../../Images/samsung.png";
import banner2 from "../../Images/Samsung main.gif";
import "./samsungCases.css"
...
const SamsungMain = () => {
  ...
  return (
    <Fragment>
      {/* <SliderHome /> */}
      <div className="samsung-ultra-banner">
        <img src={banner} alt="banner1" />
      </div>
      <div className="samsung-main-banner">
